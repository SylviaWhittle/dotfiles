...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=#333333
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND=$anaconda_foreground
  typeset -g POWERLEVEL9K_VIRTUALENV_BACKGROUND=$anaconda_background
