# Generated by Powerlevel10k configuration wizard on 2023-12-26 at 02:17 GMT.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=#7ad
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=#7aa
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  # typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=39
  # typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=#555555
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=#7af
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local     clean='%F{#BB9933}'   # yelow foreground
  ...
  typeset -g POWERLEVEL9K_ANACONDA_FOREGROUND=#66bb66
